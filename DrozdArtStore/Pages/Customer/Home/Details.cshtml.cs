...
namespace DrozdArtStore.Pages.Customer.Home
{
    ...
    public class DetailsModel : PageModel
    {
        ...
        public void OnGet(int id)
        {
            ...
            {
                MenuItem = _unitOfWork.MenuItem.GetFirstOrDefault(includeProperties: "Category,ItemType", filter: c => c.Id == id),
                MenuItemId = id
            };
        }
        ...
        public IActionResult OnPost()
        {
            ...
            {
                ShoppingCartObj.MenuItem = _unitOfWork.MenuItem.GetFirstOrDefault(includeProperties: "Category,ItemType", filter: c => c.Id == ShoppingCartObj.MenuItemId);
               return Page();
            }
        }
    }
